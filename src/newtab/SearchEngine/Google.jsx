        ...
        <div className="flex h-[100%] w-[100%] items-end justify-center">
            <div>
                ...
                <p className="flex justify-center pt-[20px]">
                    <svg
                        focusable="false"
                        className="relative top-[14px] left-[36px]"
                        width={20}
                        height={20}
                        fill="#9aa0a6"
                        aria-hidden="true"
                    ...
                    <input
                        ...
                        onInput={onInput}
                        onKeyUp={handleKeyUp}
                        className="shadow-[0 1px 6px 0 #20212447] h-[50px] w-[584px] rounded-[48px] border-[1px] border-solid border-[#c4c7ce] pl-[47px] outline-0"
                    />
                </p>
            </div>
        </div>
