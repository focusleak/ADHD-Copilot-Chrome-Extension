    ...
    return (
        <div className="flex h-[100%] w-[100%] flex-col justify-end">
            ...
            <div className="mt-[10px] flex justify-center">
                <p className="shadow-[0 1px 6px 0 #20212447] flex h-[40px] w-[650px] items-center rounded-[20px] border-[1px] border-solid border-[#ddd] bg-white p-[10px] pl-[15px] transition-[0.2s]">
                    <input
                        type="text"
                        value={queryString}
                        onInput={onInput}
