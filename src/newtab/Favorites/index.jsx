...
const Favorites = () => {
  ...
  return <div className="mt-4">
    <div className="flex flex-wrap w-[800px] mx-auto my-0">
      {list.map((item) => {
        return <a href={item.url} target="_self" key={item.name} className="w-[100px] h-[100px] hover:bg-[#E8E8E9] rounded-sm flex flex-col justify-center items-center" >
